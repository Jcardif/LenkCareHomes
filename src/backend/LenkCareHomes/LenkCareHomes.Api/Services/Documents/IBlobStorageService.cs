...
public interface IBlobStorageService
{
    ...
    Task UploadBlobAsync(string blobPath, byte[] content, string contentType, string containerName = BlobContainers.Documents);
    ...
    /// <param name="containerName">The container name (default: documents).</param>
    /// <returns>Task completing when upload is finished.</returns>
    Task UploadBlobAsync(string blobPath, Stream content, string contentType, string containerName = BlobContainers.Documents);
    ...
    Task<byte[]> DownloadBlobAsync(string blobPath, string containerName = BlobContainers.Documents, CancellationToken cancellationToken = default);
