...
public interface IAuthService
{
    ...
    Task<MfaSetupResponse> SetupMfaAsync(Guid userId, string passkeySetupToken, CancellationToken cancellationToken = default);
    ...
    Task<bool> ConfirmMfaSetupAsync(MfaSetupConfirmRequest request, string passkeySetupToken, CancellationToken cancellationToken = default);
